...
// taken and modified fro https://github.com/justinas/alice
...
// NewMiddlewareChain creates a new chain,
...
func (c Chain) ThenHandle(f func(w http.ResponseWriter, r *http.Request)) http.Handler {
